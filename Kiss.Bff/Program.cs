...
try
{
    ...
    builder.Services.AddLogboekProxy(builder.Configuration["LOGBOEK_OBJECTEN_BASE_URL"], builder.Configuration["LOGBOEK_OBJECTEN_TOKEN"], builder.Configuration["LOGBOEK_OBJECT_TYPE_URL"], builder.Configuration["LOGBOEK_OBJECT_TYPE_VERSION"]);
