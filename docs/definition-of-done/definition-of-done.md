...
Er is een DPIA opgesteld voor de applicatie. Deze kunt u [hier inzien](<https://github.com/Klantinteractie-Servicesysteem/KISS-frontend/blob/main/docs/files/ICATT-KISS-Data-Processing-Impact-Assessment-(DPIA).pdf>).
...
- WCAG wordt handmatig gecontroleerd m.b.v. lighthouse. De resultaten van deze test vindt u [hier](https://github.com/Klantinteractie-Servicesysteem/KISS-frontend/blob/main/docs/files/WCAG-Lighthouse-Report-20231010.pdf)

### Pentest

Pentests (frontend en backend) worden wekelijks uitgevoerd. Een voorbeeld van een rapport uit juli 2024 staat [hier](https://github.com/Klantinteractie-Servicesysteem/KISS-frontend/blob/main/docs/files/WebsiteScanner_30077801_771804-20240711-2302_0.pdf).
