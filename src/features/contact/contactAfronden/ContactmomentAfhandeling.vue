...
} from "@/features/contact/contactAfronden/write-contactmoment-details";
import BackLink from "@/components/BackLink.vue";
import AfdelingenSearch from "@/components/afdelingenSearch/AfdelingenSearch.vue";
import { fetchAfdelingen } from "@/components/afdelingenSearch/afdelingen";
import contactmomentVraag from "./ContactmomentVraag.vue";

// this is a design mistake. the contact formulier should not be here. no architecture is going to fix that. so we'll accept this anomalie
...
import MaxLengthTextArea from "@/features/contact/contactAfronden/MaxLengthTextArea.vue";

// todo: refactor, illegal cross feature reference. use a slot, or move the part of this compontent that contains the canceller to the vew for instance
